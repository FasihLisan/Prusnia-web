...
<table class="table table-hover align-middle" width='20%'cellspacing="0">
    <thead>
        ...
        <tr>
            ...
            <td><?= $d['deskripsi']; ?> </td>
            <td><button href="deleteGalery.php?id_galeri=<?= $d['id_galeri'];?>" onclick="confirmationHapusData('deleteGalery.php?id_galeri=<?= $d['id_galeri'] ?>')" class="btn btn-danger sweet-delete" role="button">Hapus</button></td>
        </tr>
        <?php endforeach ?>
        </tbody>
</table>
