...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <p>Jenis Kelamin</p>
  <p><input type='radio' name='jenis_kelamin' value='laki-laki' <?= $user->getUserById($_SESSION['userdata']['id_users'])['jenis_kelamin'] == "laki-laki" ? "checked" : "" ?> />Laki-laki</p>
  ...
  <button type="submit" name="submit" class="btn btn-success px-5 mb-4"><i class="fa-solid fa-floppy-disk"></i> Simpan</button>
</form>
